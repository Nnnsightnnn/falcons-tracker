...
export const CAP_STATE = {
  ...
  recentMoves: [
    { date: "2026-08-31", description: "Rounded out the roster on the Monday waiver wire, claiming LB Yasir Abdullah (from Jacksonville), EDGE Jared Ivey (from Seattle) and OT Cameron Williams (from Philadelphia). In corresponding moves the Falcons waived DL Zach Harrison, a former third-round pick with 8.5 sacks over three seasons, along with DBs Jammie Robinson and Natrone Brooks. All minimum-salary claims, so negligible top-51 cap impact. Separately built a 15-man practice squad (one spot open) that brought back cutdown casualties RB Tyler Goodson, CB Darnay Holmes, EDGE Cameron Sample and rookie RB Cash Jones" },
