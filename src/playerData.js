...
export const NEWS_DIGEST = {
  generatedAt: "2026-07-23T08:32:00Z",
  cover: {
    kicker: "DEAD PERIOD · FINAL DAY · Rookies Report Tomorrow and the One Question That Matters Is Still Open: Atlanta Enters Training Camp Without a Named Starting Quarterback, and the Staff Has Been Quietly Telling You for Six Weeks Exactly How It Intends to Decide",
  ...
  topics: [
    {
      title: "CAMP OPENS TOMORROW, AND THE LAST WORD BEFORE THE DOORS OPEN IS A WARNING ABOUT DEPTH: with rookies reporting Friday, the syndicated pre-camp wire read frames Atlanta's summer around three soft spots the offseason did not fully close, an unsettled right tackle, a linebacker room rebuilt from scratch, and an edge rotation bracing for a James Pearce Jr. suspension, all of it landing the same week the roster walks back in",
      detail: "Syndicated pre-camp wire item ('Falcons Training Camp Opens Friday As Depth Chart Issues Draw Concern,' carried Jul 21 across the Beasley/regional network including Kicks 99, WGAC and Hot Augusta) read alongside the Yahoo Sports reporting-date roundup: the freshest framing on the board as the dead period closes, and it is deliberately less rosy than the team-site preview series. The through-line is that Atlanta's headline talent is not the question, its depth behind three specific jobs is. Right tackle is the sorest spot: Jawaan Taylor, signed in April to replace the abruptly retired Kaleb McGary, is still working back from the arm injuries that kept him out of all spring team work, which has thrown first-team reps to third-year man Michael Jerrell and newly acquired ex-Chief Wanya Morris, with Storm Norton parked on reserve/PUP. The linebacker level, stripped when Kaden Elliss took the green dot to New Orleans, now runs through Divine Deablo and a to-be-settled partner. And the edge room, second in the league with 57 sacks last year, is quietly built as contingency against a Pearce suspension the league still has not ruled on. The report's verdict matches the national one: the skill positions are elite, the load-bearing unknowns are few but real, and camp is where they get answered. Rookies report tomorrow, veterans Tuesday, pads on Jul 29.",
      category: "general",
      sourceUrl: "https://kicks99.com/2026/07/21/falcons-training-camp-opens-friday-as-depth-chart-issues-draw-concern/",
      sourceLabel: "Beasley regional wire / Yahoo Sports",
    },
    {
...
export const INTERVIEWS = {
  generatedAt: "2026-07-23T08:32:00Z",
  windowLabel: "Dead Period · Final Day · Rookies Report Tomorrow Jul 24 → Veterans Jul 28 → First Camp Practice Jul 29 → First Open Practice Jul 31",
  sessions: [
    {
      id: "pitts-2026-06-29",
