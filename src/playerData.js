...
export const NEWS_DIGEST = {
  generatedAt: "2026-04-28T08:10:00Z",
  sources: [
    ...
    "National Today", "Freedom 96.9", "Athlon Sports", "RantSports",
  ],
  topics: [
    {
      title: "Rookie-class week opens: minicamp set for May 8–11, UDFA wave hardens, tryout invites round out the roster",
      detail: "Tuesday's news cycle is all rookie group. Atlanta is taking the second of two NFL-allowed post-draft windows — May 8–11 at Flowery Branch — for its three-day rookie minicamp. The roster combines the six drafted rookies, the priority UDFAs (Carlos Allen, Brockermeyer, Cash Jones, Kam Dewberry, Riley Mahlman, plus pass-catchers Anthony II, Rutherford, Marion), and a tryout-invite wave including Georgia Tech S Clayton Powell-Lee, ETSU RB Devontae Houston, Indiana WR Jonathan Brady, and CB Nyland Green. First on-field rep of Stefanski-Rees-Ulbrich language for the rookie group.",
      category: "general",
    },
    {
      title: "UDFA list firms up: Carlos Allen, Brockermeyer headline; Bill Callahan inherits a real OL-development pile",
      detail: "Falcoholic's UDFA tracker and SI/NFL.com cross-checks converged Monday on Atlanta's full priority list: DT Carlos Allen (Houston, FBS-leading 80 tackles among interior DLs, 27 run stops led the Big 12), C James Brockermeyer (Miami, All-ACC 3rd team, Senior Bowl), RB Cash Jones (Georgia, third-down profile), OL Kam Dewberry (Alabama LG), OT Riley Mahlman, WR Vinny Anthony II, WR Malik Rutherford, return man Keelan Marion (former BYU All-American), TE Jack Velling (Oregon State / Nate Carter teammate), CB Malcolm DeWalt (Akron), plus QB Jack Strand (6'8 320, Minnesota State-Moorhead) as the camp-arm flier.",
      category: "draft",
    },
    {
      title: "Drake London extension officially top of the contract queue — Cunningham opens talks this week",
      detail: "With pick #231 in the books, Ian Cunningham confirmed Saturday night that London is 'top of mind' and that the Falcons would 'turn to extensions' immediately post-draft. London plays 2026 on the $16.8M 5th-year option (exercised Apr). Market reset is Jaxon Smith-Njigba's 4yr / $168.6M ($42.15M APY) Seattle deal from Mar 25 and Garrett Wilson's $131M Jets number. Heavy/SI/twsn.net projections cluster around 4yr / $128M ($32M APY, $82–90M guaranteed) — the team's stated goal is to get it done before training camp opens July 22.",
      category: "contracts",
    },
    {
      title: "Bijan Robinson long-term talks active too — Gibbs/Detroit looms as the RB-market reset risk",
      detail: "Bijan's 5th-year option was picked up Apr 10–13 at $11.32M for 2027. Schefter (per The Falcoholic) and Heavy peg the long-term as 'expected this offseason,' with ESPN's contract-prediction piece projecting a deal in the $20M+ APY range. The Detroit complication is real: Jahmyr Gibbs is in the same negotiating window and any RB1 deal there resets the comp. Bijan's case (NFL-leading 2,298 scrimmage yards, 11 TDs, All-Pro in 2025) is at least Gibbs-equal on the resume.",
      category: "contracts",
    },
    {
      title: "Schedule release locked for May 13 or May 14 — Madrid international game confirmed for Atlanta's slate",
      detail: "CBS Sports and FBSchedules now have the NFL targeting May 13–14 for the 2026 schedule release. Atlanta's opponents are already locked (home: NO, TB, CAR, SF, SEA, BUF, NYJ, IND, MIN) but the dates and prime-time count are unknown. Confirmed: Atlanta is one of the nine teams playing an international game in 2026, with Madrid as the destination. The release will rotate the dashboard hero from rookie-class into 'offseason-lull / schedule-release countdown' mode May 5.",
      category: "general",
    },
    {
      title: "Stefanski's Day 3 framing — 'we emphasized fit' — frames the rookie class for the install",
      detail: "Sunday's post-draft features from The Falcoholic and AJC both led on Stefanski's repeated 'fit' theme. Branch (Georgia, Stefanski-style versatility), Daniels (Cheetah role analog to Cleveland LB usage), and Perkins (third-down sub-package gambit) read as scheme-and-culture picks, not best-available board grabs. On Branch specifically, Stefanski: 'really has a great schematic fit, also a great personal fit for what we believe in and how hard he works.' May 8–11 is the first place that framing meets a whistle.",
      category: "coaching",
    },
    {
      title: "Class grades range B- to B+: Day 2 universally praised, Day 3 splits the rooms",
      detail: "Final report cards converged Monday: NFL.com's Chad Reuter handed out the harshest grade at B- (citing the 2026 R1 traded last spring for James Pearce Jr. and zero edge picks); CBS's Carter Bahns gave the highest at B+, refusing to penalize the no-R1 reality. ESPN graded Day 2 (Terrell at #48, Branch at #79) as A/A-; Day 3 (the LB double-dip plus Onianwa) is what split rooms — Edwards called Daniels 'a player without a position.' Net consensus: solid B / B+ class given the no-R1 starting point.",
      category: "draft",
    },
    {
      title: "Avieon Terrell on landing in Atlanta with A.J.: 'the dream came true' — first joint media Sunday",
      detail: "atlantafalcons.com's Sunday feature captured the Terrell brothers' first joint availability. Same Atlanta-area HS, back-to-back at Clemson, but never overlapped on a roster. Avieon (5'11 / 184, 5 forced fumbles in 2025 — Clemson DB record) projects as the immediate slot/nickel competition for Mike Hughes; A.J. stays at outside CB1 on his $81M extension. The Falcoholic's projected 2026 starting lineup landed Avieon in the nickel mix and Branch as the 3WR option ahead of Zaccheaus.",
      category: "draft",
    },
    {
      title: "Penix ACL rehab: Stefanski stays on 'where he needs to be,' Week 1 publicly the target",
      detail: "Stefanski's most recent update and post-draft confirmations have him holding to the 'right where he needs to be' line on Penix's recovery from the Nov 16 ACL tear (surgery Nov 25). Penix himself remains publicly on the Week 1 target — the 9–12 month window lands at kickoff. Tua's 1yr / $1.3M deal is the bridge; Stefanski has not anointed a starter and won't until OTAs at the earliest. Voluntary minicamp Apr 21–23 had Tua taking every 1st-team rep, Penix limited to rehab + install observation.",
      category: "injuries",
    },
    {
      title: "Kyle Pitts plays 2026 on signed $15.045M franchise tag — July 15 the long-term deadline",
      detail: "Pitts signed his non-exclusive tag Apr 7 and reported to voluntary minicamp Apr 21–23. Heavy's insider piece pegs a long-term resolution at roughly 4yr / $68M ($35M guaranteed) — a number that would slot him behind only Kittle and McBride at the position. The hard deadline is July 15: miss it and he plays the 2026 season on the 1yr / $15.045M tag, with another tag-or-walk call in 2027. Pitts sits 3rd in the contract queue behind London and Bijan.",
      category: "contracts",
    },
    {
      title: "Phase 2 walkthroughs open May 4 — first non-rookie reps under the new staff",
      detail: "The veteran offseason program rotates into Phase 2 walkthroughs on May 4 — the next milestone after rookie minicamp. That's the first window where the Stefanski-Rees offensive install meets the full skill group on the field (still no team contact, but on-field installation with the OL/WR/TE/RB groups). Phase 3 OTAs (May 18–19 / 21 / 26–27 / 29 / June 8–9 / 11) follow, with mandatory veteran minicamp June 16–18 closing the offseason program before camp opens July 22.",
      category: "coaching",
    },
    {
      title: "DT room post-draft: Maason Smith + Zach Harrison + Dorlus + Anterio Thompson + UDFA Allen",
      detail: "The Apr 17 player-for-player swap with Jacksonville sent Ruke Orhorhoro out and brought Maason Smith in. With the Apr 25–26 draft adding 6th-rounder Anterio Thompson at #208 and the priority UDFA signing of Houston's Carlos Allen, the interior DL room now reads: Smith (NT frame), Harrison (3-tech), Dorlus (rotation 3-tech), Thompson (developmental), Allen (camp-stay candidate). Reduced — not eliminated — but the room is finally back to full numbers heading into rookie minicamp.",
      category: "free-agency",
    },
    {
      title: "Calendar locked: Phase 2 May 4 → rookie camp May 8–11 → schedule release May 13–14 → OTAs May 18",
      detail: "From here through May, the next four milestones are: Phase 2 walkthroughs open Monday May 4; rookie minicamp at Flowery Branch May 8–11; 2026 NFL schedule release Wednesday/Thursday May 13–14; Phase 3 OTAs begin May 18. Then mandatory veteran minicamp June 16–18, dead period through July 21, and training camp opens July 22 in Flowery Branch.",
      category: "general",
    },
  ],
};
