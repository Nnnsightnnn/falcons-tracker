...
export const NEWS_DIGEST = {
  ...
  cover: {
    kicker: "TRAINING CAMP · DAY ONE · The Rookies Are In the Building and the One Question That Matters Is Still Open: Atlanta's 2026 Class Reported to Flowery Branch This Morning, Veterans Follow Tuesday, and the Quarterback Job That Decides the Season Stays Blank Until the Pads Come On",
...
export const INTERVIEWS = {
  generatedAt: "2026-07-24T13:00:00Z",
  windowLabel: "Training Camp · Rookies Reported Jul 24 → Veterans Jul 28 → First Padded Practice Jul 29 → First Open Practice Jul 31",
  sessions: [
    {
      id: "pitts-2026-06-29",
