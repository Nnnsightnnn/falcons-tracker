...
export const PLAYERS = [
  ...
  },
  {
    ...
    posSlot: "REDGE",
    positionGroup: "defense",
    depthRank: 3, // REDGE reserve behind Za'Darius Smith; kept at 3 with Ebukam slotting LEDGE-2
...
export const NEWS_DIGEST = {
  ...
  cover: {
    ...
    headLine1: "The roster is set. And there are four quarterbacks on it.",
    headEm: "Atlanta reached the 53-man limit Sunday, and the headline was the room the club would not trim: Tua Tagovailoa, Michael Penix Jr., veteran Cooper Rush and undrafted rookie Jack Strand all stuck, one of a handful of four-quarterback rosters in the league. Ian Cunningham then dealt cornerback Clark Phillips III and a 2027 fifth-round pick to Chicago for defensive tackle Gervon Dexter Sr., a 24-year-old former second-round starter, on his old assistant-GM home turf.",
    headLine3: "The cuts carried real surprises. Running back Tyler Goodson, the preseason's best back and a special-teams piece, edge Azeez Ojulari and slot corner Darnay Holmes were all released and become practice-squad targets when the market opens. The build skews to the trenches and the back end: only two running backs, a deep offensive line and secondary, and just five outside linebackers behind a group already thinned by Jalon Walker's season-ending ACL and James Pearce Jr.'s eight-game ban, which begins today. The quarterback question outlives the deadline. Stefanski still will not name a Week 1 starter, Ian Rapoport reads the silence as a lean toward Tua because Penix is not yet cleared for game contact, and 92.9 The Game's Mark Zinno expects Penix to open at Pittsburgh anyway.",
    deck:
