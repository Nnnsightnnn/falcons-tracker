...
export const FRONT_OFFICE = [
  ...
  },
  {
    ...
    tier: "POSITION COACHES",
    since: 2026,
    bio: "New hire. Runs an edge room reshaped by August: Jalon Walker lost for the year (ACL) and James Pearce Jr. facing an eight-game ban, so the summer rotation now leans on veterans Za'Darius Smith and Azeez Ojulari with Samson Ebukam and Bralen Trice behind them. Still the position group most central to Ulbrich's 2026 jump.",
