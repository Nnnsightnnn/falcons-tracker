...
export const NEWS_DIGEST = {
  ...
  topics: [
    ...
    {
      title: "THE OTHER SUMMER, THE ONE THAT DECIDES THE BACK OF THE ROSTER: the Falcoholic maps five genuine down-the-depth-chart fights on offense, QB3 (Siemian vs. a Division II arm), RB3, a wide-open WR5, backup center, and swing tackle",
      detail: "The Falcoholic (Dave Choate, filed Mon Jul 6 at 12:00 PM, carried by Yahoo Sports): a useful corrective to the starter-obsessed previews, because these are the spots that decide games when someone goes down. QB3: Trevor Siemian, age 35 with 33 career starts but no regular-season snap since 2023, is the favorite at $1.3M, though Division II standout Jack Strand has thrown well enough to make it interesting, and with both Tagovailoa and Penix carrying injury histories the third arm actually matters here. RB3: Nate Carter (long speed, special-teams reps), Tyler Goodson (most experienced, 33 games, kick-return value) and rookie Cash Jones, the Georgia back the staff is already running at wide receiver. WR5 is the wide-open one: Drake London, Jahan Dotson, Zachariah Branch and Olamide Zaccheaus hold the top four, and behind them sit perennial camp standouts Chris Blair and Dylan Drummond, UDFAs Keelan Marion, Vinny Anthony and Le'Meke Brockington, plus new UFL signing Antwane 'Juice' Wells, who adds physicality to a group Choate notes runs small. Backup center is Corey Levin (88 NFL games, and a Bill Callahan alum from Tennessee) against rookie technician James Brockermeyer, and the winner reshapes the whole interior reserve group. Swing tackle goes to Wanya Morris, acquired from Kansas City, unless Mike Jerrell or Jack Nelson force the issue.",
      category: "general",
