...
export const NEWS_DIGEST = {
  ...
  cover: {
    kicker: "TRAINING CAMP · VETERANS REPORT TOMORROW · The Rookie-Only Window Closes at Flowery Branch and the One Question That Matters Is Still Open: Atlanta's 2026 Class Is Through Its Head-Start Weekend, the Veterans Walk In Tuesday, and the Quarterback Job That Decides the Season Stays Blank Until the Pads Come On Wednesday",
  ...
  topics: [
    {
      title: "VETERANS REPORT TOMORROW AND THE ROOKIE HEAD-START WINDOW CLOSES: the 2026 class reported Friday and the dead period is over, with Atlanta's draftees and undrafted signees through their rookie-only weekend at Flowery Branch, the full veteran roster due Tuesday Jul 28 and the first full-team practice Wednesday Jul 29, and the same three load-bearing questions the offseason could not close, an unsettled right tackle, a linebacker room rebuilt from scratch, and an edge rotation bracing for a James Pearce Jr. suspension, now walking through the door together",
      detail: "Team-site and league reporting-date roundup (atlantafalcons.com camp schedule, plus a Yahoo Sports recap noting the rookies reported and the Bijan Robinson-Brian Robinson backfield drew a No. 1 ranking) with the class of 2026 in the building since Friday, Jul 24: the dead period is over and the freshest framing on the board is no longer a preview but a checkpoint. The 19-player rookie class, six draft picks and 13 undrafted free agents, has taken its head-start rookie-only reps and now hands the building over to the veterans, who report tomorrow, Tuesday Jul 28, and the headline name in the group is third-round wideout Zachariah Branch, the 4.35 speedster Tua Tagovailoa has already likened to Jaylen Waddle and who is in line to seize both return jobs. The syndicated pre-camp wire read that led the board through the weekend ('Falcons Training Camp Opens Friday As Depth Chart Issues Draw Concern,' carried Jul 21 across the Beasley regional network) still frames the summer correctly: Atlanta's headline talent is not the question, its depth behind three specific jobs is. Right tackle is the sorest spot, with April signing Jawaan Taylor still working back from arm injuries that cost him all spring team work, first-team reps splitting between third-year man Michael Jerrell and ex-Chief Wanya Morris, and Storm Norton parked on reserve/PUP. The linebacker level, stripped when Kaden Elliss took the green dot to New Orleans, now runs through Divine Deablo and a to-be-settled partner. And the edge room, second in the league with 57 sacks last year, is quietly built as contingency against a Pearce suspension the league still has not ruled on. Rookies through the weekend, veterans Tuesday, pads on Jul 29.",
      category: "general",
...
export const INTERVIEWS = {
  ...
  windowLabel: "Training Camp · Rookies In (Jul 24) → Veterans Report Jul 28 → First Padded Practice Jul 29 → First Open Practice Jul 31",
  sessions: [
    {
      id: "pitts-2026-06-29",
